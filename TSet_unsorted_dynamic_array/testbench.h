...
#define TTEST_FUNC_OUTPUT_FRMSTR "u"			///< Definice formátovacího řetězce (ovšem bez znaku `%`) určeného pro tisk výstupní hodnoty z operací testovaného ADT
 ...
 *  \details Tisk hodnoty elementu ADT, na kterou ukazuje předaný iterátor.
